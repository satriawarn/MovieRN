...
const getMovieDetail = async (movieId: number) => {
  try {
    ...
    console.log(
      console.log(
        '🚀 ~ file: MovieDetailScreen.tsx:16 ~ getMovieDetail ~ error:',
        error,
      ),
      error,
    );
...
const getMovieCastDetail = async (movieId: number) => {
  try {
    ...
    console.log(
      console.log(
        '🚀 ~ file: MovieDetailScreen.tsx:45 ~ getMovieDetail ~ error:',
        error,
      ),
      error,
    );
    ...
    <ScrollView
      ...
      <View>
        ...
        <Text style={styles.tagline}>
          {movieData?.tagline !== '' ? movieData.tagline : 'Default Tagline'}
        </Text>
      </View>
        ...
        <FlatList
          ...
          renderItem={({item, index}) => (
            <CastCard
              ...
              isLat={index == movieCastData.length - 1 ? true : false}
